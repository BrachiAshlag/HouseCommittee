...
CREATE TABLE `faults` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_fault_building_idx` (`building_id`),
  CONSTRAINT `FK_fault_building` FOREIGN KEY (`building_id`) REFERENCES `buildings` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `faults` VALUES (1,'elevators',1),(2,'A light bulb burned out',2);
